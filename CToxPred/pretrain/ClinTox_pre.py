...
# 파일 경로 정의
train_file_path = r"C:\Users\ADS_Lab\Desktop\JH\Paper_Replication\CToxPred\dataset\ClinTox_train_no_salt.txt"
test_file_path = r"C:\Users\ADS_Lab\Desktop\JH\Paper_Replication\CToxPred\dataset\ClinTox_test_no_salt.txt"
...
best_model_path = "best_ClinTox_classifier_trained.model"  # 가장 성능 좋은 모델 파일 경로
...
for epoch in range(epochs):
    ...
    with torch.no_grad():
        # 파일명에 에폭 번호 포함
        output_file = f"./ClinTox2/epoch_{epoch + 1}_predictions.txt"
