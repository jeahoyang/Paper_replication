...
def _generate_predictions_ssl(smiles_list: List[str]) -> Dict[str, any]:
    ...
    # path = r"C:\Users\ADS_Lab\Desktop\JH\Paper_Replication\CToxPred2\CToxPred2\models\decriptors_preprocessing\decriptors_preprocessing\global_preprocessing_pipeline.sav"
    ...
    path = ["CToxPred2", "models", "random_forest", "random_forest", "hERG", "_ssl_herg_model.joblib"]
    ...
    path = ["CToxPred2", "models", "random_forest", "random_forest", "Nav1.5", "_ssl_nav_model.joblib"]
    ...
    path = ["CToxPred2", "models", "random_forest", "random_forest", "Cav1.2", "_ssl_cav_model.joblib"]
    herg_model = joblib.load(os.path.join(*path))
    proba_predictions = herg_model.predict_proba(molecular_features)
...
def _generate_predictions_sl(smiles_list: List[str]) -> Dict[str, any]:
    ...
    path = ["CToxPred2", "models", "model_weights", "model_weights", "hERG", "_herg_checkpoint.model"]
    ...
    path = ["CToxPred2", "models", "model_weights", "model_weights", "Nav1.5", "_nav15_checkpoint.model"]
    ...
    path = ["CToxPred2", "models", "model_weights", "model_weights", "Cav1.2", "_cav12_checkpoint.model"]
