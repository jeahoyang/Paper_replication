...
# 파일 경로 정의
train_file_path = r"C:\Users\ADS_Lab\Desktop\JH\Paper_Replication\CToxPred2\dataset\hERG_train_no_salt.txt"
test_file_path = r"C:\Users\ADS_Lab\Desktop\JH\Paper_Replication\CToxPred2\dataset\hERG_test_no_salt.txt"
...
for epoch in range(epochs):
    ...
    with torch.no_grad():
        # 파일명에 에폭 번호 포함
        output_file = f"./herf/epoch_{epoch+1}_predictions.txt"
