...
parser.add_argument('--network_paths',
                    default=['PPI=./processed_dataset/six_net/PPI_for_pyG_origin.txt',
...
parser.add_argument("--kcg", default='./processed_dataset/six_net/kcg_intersec_origin.csv', help='Know cancer gene')
# parser.add_argument("--Maybe_cancergene", default="./processed_dataset/six_net/Merge_maybe_cancergene.txt")
parser.add_argument("--Maybe_cancergene", default="STRING_10foldTEST/fold_1/train.txt")
